...
import com.inmoglass.txtreaderlib.R;
...
public class TxtConfig {
    ...
    public static int Page_PaddingLeft = 16;//in px
    public static int Page_PaddingBottom = 75;//in px
    public static int Page_PaddingTop = 15;//in px
    public static int Page_PaddingRight = 16;//in px
    public static int Page_LinePadding = 8;//in px 换行间距
    public static int Page_Paragraph_margin = 18;//in px,为0，没有间距  行间距

    public int Page_Switch_Mode = PAGE_SWITCH_MODE_COVER;
    public static int MAX_TEXT_SIZE = 54;//in px
    public static int MIN_TEXT_SIZE = 22;//in px
    public static int DEFAULT_TEXT_SIZE = 22;//in px
    ...
    public int textColor = Color.WHITE;//字体颜色
    public int backgroundColor = Color.BLACK;//背景颜色
    ...
    public static boolean DebugMode = false;//debug模式会进行打印日志，默认是开启
    ...
    public static int getTextColor(Context context) {
        SharedPreferences share = getS(context);
        return share.getInt(C_TEXT_COLOR, Color.WHITE);
    }
...
//        return share.getInt(C_BACKGROUND_COLOR, R.color.hwTxtReader_styleColor5);
        return share.getInt(C_BACKGROUND_COLOR, Color.BLACK);
    }
