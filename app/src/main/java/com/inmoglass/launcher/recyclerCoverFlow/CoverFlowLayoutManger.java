...
public class CoverFlowLayoutManger extends RecyclerView.LayoutManager {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        LogUtils.i(TAG, "onLayoutChildren");
        ...
        LogUtils.i(TAG, "width = " + mDecoratedChildWidth + ",height = " + mDecoratedChildHeight);
        ...
        LogUtils.i(TAG, "mStartX = " + mStartX + ",mStartY = " + mStartY);
    ...
    public int scrollHorizontallyBy(int dx, RecyclerView.Recycler recycler, RecyclerView.State state) {
        LogUtils.i(TAG, "scrollHorizontallyBy");
    ...
    public void scrollToPosition(int position) {
        LogUtils.i(TAG, "scrollToPosition = " + position);
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        LogUtils.i(TAG, "smoothScrollToPosition = " + position);
    ...
    public void onAdapterChanged(RecyclerView.Adapter oldAdapter, RecyclerView.Adapter newAdapter) {
        LogUtils.i(TAG, "onAdapterChanged");
    ...
    private int getHorizontalSpace() {
        LogUtils.i(TAG, "getHorizontalSpace = " + (getWidth() - getPaddingRight() - getPaddingLeft()));
    ...
    private int getVerticalSpace() {
        LogUtils.i(TAG, "getVerticalSpace = " + (getHeight() - getPaddingBottom() - getPaddingTop()));
    ...
    private float getMaxOffset() {
        LogUtils.i(TAG, "getMaxOffset = " + ((getItemCount() - 1) * getIntervalDistance()));
    ...
    private float computeScale(int x) {
        ...
        LogUtils.i(TAG, "computeScale = " + scale);
        return scale;
    }
    ...
    private float computeGreyScale(int x) {
        ...
        LogUtils.i(TAG, "computeGreyScale = " + value);
        return value;
    }
    ...
    private float computeAlpha(int x) {
        ...
        LogUtils.i(TAG, "computeAlpha = " + alpha);
        return alpha;
    }
    ...
    private int calculateOffsetForPosition(int position) {
        LogUtils.i(TAG, "calculateOffsetForPosition = " + Math.round(getIntervalDistance() * position));
    ...
    private void startScroll(int from, int to) {
        LogUtils.i(TAG, "startScroll,from =  " + from + ",to = " + to);
    ...
    private int getIntervalDistance() {
        LogUtils.i(TAG, "getIntervalDistance=" + Math.round(mDecoratedChildWidth * mIntervalRatio));
    ...
    /**
     * 该方法主要用于 recycler.coverflow.RecyclerCoverFlow#getChildDrawingOrder(int, int) 判断中间位置
     *
    ...
    /**
     * 获取中间位置
     * <p>Note:该方法主要用于 recycler.coverflow.RecyclerCoverFlow#getChildDrawingOrder(int, int) 判断中间位置
